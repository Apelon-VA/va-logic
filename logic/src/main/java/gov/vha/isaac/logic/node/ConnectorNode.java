...
public abstract class ConnectorNode extends AbstractNode {
    ...
    public ConnectorNode(LogicGraph logicGraphVersion, DataInputStream dataInputStream) throws IOException {
    ...
    public ConnectorNode(LogicGraph logicGraphVersion, AbstractNode... children) {
