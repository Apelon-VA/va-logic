...
public class FeatureNodeWithUuids extends TypedNodeWithUuids {
    ...
    public FeatureNodeWithUuids(LogicGraph logicGraphVersion, DataInputStream dataInputStream) throws IOException {
    ...
    public FeatureNodeWithUuids(LogicGraph logicGraphVersion, UUID typeConceptUuid, AbstractNode child) {
    ...
    public String toString() {
        return "FeatureNode[" + getNodeIndex() + "]: " +
                 operator +
                ", units:" + getConceptChronicleText(unitsConceptUuid) +
                super.toString();
    }
