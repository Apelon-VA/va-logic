...
public class LiteralNodeInteger extends LiteralNode {
    ...
    public LiteralNodeInteger(LogicGraph logicGraphVersion, DataInputStream dataInputStream) throws IOException {
        super(logicGraphVersion, dataInputStream);
        literalValue = dataInputStream.readInt();
    }


    public LiteralNodeInteger(LogicGraph logicGraphVersion, int literalValue) {
